...
$anyPort = normalizeRuleRecord([
    'name' => 'HTTP and HTTPS family',
    'action' => 'allow',
    'source' => '',
    'protocol' => 'any',
    'port' => '443',
], 4);
if ($anyPort['protocol'] !== 'any' || $anyPort['port'] !== '443') {
    throw new RuntimeException('Any-protocol port rule was not accepted as a logical rule.');
}
...
if (count($postedRules) !== 1 || $postedRules[0]['protocol'] !== 'any' || $postedRules[0]['port'] !== '443') {
