...
$requiredKeys = [
    ...
    'Rules are evaluated top-to-bottom Leave source blank for any source Leave port blank for all ports A port can use TCP or UDP Any applies to both',
    'Use IPv6 addresses or CIDRs Leave source blank for any source Leave port blank for all ports A port can use TCP or UDP Any applies to both',
    'Last apply state',
